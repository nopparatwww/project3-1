...
function newBox(){
    ...
    li.innerHTML += `<div id="${sum}" class="box- ${sum}">
        <div class="box-img">
            <img src="https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?q=80&w=1988&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width="100px">
        </div>
        <div class="text-box">
...
function byCountry(address){
    ...
    mainBox.forEach((box)=>{
       ...
       if(addressSpan.innerText == address){
        Swal.fire({
            icon: "success",
            title: 'ค้นพบที่อยู่',
          }).then(()=>{
